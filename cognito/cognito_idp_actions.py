...
class CognitoIdentityProviderWrapper:
    ...
    def _secret_hash(self, user_name):
        ...
        :param user_name: The username to use when calculating the hash.
    ...
    def sign_up_user(self, user_name, password, user_email):
        ...
        to send email to the specified email address. The email contains a code that
        can be used to confirm the user.

        When the user already exists, the user status is checked to determine whether
        the user has been confirmed.

        :param user_name: The username that identifies the new user.
